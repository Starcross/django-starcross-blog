...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,s]}}})());hljs.registerLanguage("django",(()=>{"use strict";return e=>{const t={
...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[t]}]}}})());hljs.registerLanguage("cpp",(()=>{"use strict";function e(e){
...
},{begin:s+":",end:":",returnBegin:!0,returnEnd:!0,relevance:0}])}}})());hljs.registerLanguage("nginx",(()=>{"use strict";return e=>{const n={
...
begin:s+n+"$"}]}}})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},r]}}})());hljs.registerLanguage("yaml",(()=>{"use strict";return e=>{
